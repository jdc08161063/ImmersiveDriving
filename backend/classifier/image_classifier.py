...
class ImageClassifier:
    def __init__(self): #, network_config_file=None, weights=None):
        ...
        self.translator = ct.CategoryTranslator(ournet_categories_file="/home/ImmersiveDriving/backend/classifier/config/categories_ournet6.txt",
                                                othernet_categories_file="/home/ImmersiveDriving/backend/classifier/config/categories_places365.txt",
                                                translation_othernet_file="/home/ImmersiveDriving/backend/classifier/config/categories_translation.txt")
